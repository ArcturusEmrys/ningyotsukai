...
#[template(resource = "/live/arcturus/puppet-inspector/render_preview/opengl.ui")]
pub struct InoxGLPreviewImp {
...
impl ObjectSubclass for InoxGLPreviewImp {
    const NAME: &'static str = "PIInoxGLPreview";
    type Type = InoxGLPreview;
...
impl ObjectImpl for InoxGLPreviewImp {
    fn constructed(&self) {
        self.parent_constructed();
    }
}

impl WidgetImpl for InoxGLPreviewImp {}

impl BoxImpl for InoxGLPreviewImp {}

glib::wrapper! {
    pub struct InoxGLPreview(ObjectSubclass<InoxGLPreviewImp>)
