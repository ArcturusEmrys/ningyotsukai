...
impl DrawCommandList {
    ...
    pub fn flush(
        ...
        let (_, (results, submission_index)) =
            rayon::join(
                || {
                    me.commands
                .par_chunks(optimal_chunk_size)
                .enumerate()
                .map(|(thread_idx, commands)| {
                    let mut encoder =
                        draw_session
                            .resources
                        ...
                        for command in commands.iter() {
                            match command {
                                ...
                                DrawCommand::DrawPart {
                                    ...
                                    let surface_color_attach =
                                        Some(color_view.as_color_attachment());
                                    let gbuffer_color = [
                                ...
                                DrawCommand::EndComposite {
                                    ...
                                    let blend = Some(blend_mode_to_state(
